...
<body>
    <h1 class="service-name">WebServicesUtils</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#WebServicesUtilsInterface'>WebServicesUtilsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='WebServicesUtilsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='WebServicesUtilsInterface' colspan='3' class='content-td'>WebServicesUtilsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>wsdlToJolie</span></td>
                <td class='content-td'>
                ...
                <td class='content-td'>
                    ...
                    <button
                        onclick='openDetails("wsdlToJolie")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_wsdlToJolie' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
...
(
            ...
            <tr id='doc_wsdlToJolie' style='display:none'>
                <td></td>
