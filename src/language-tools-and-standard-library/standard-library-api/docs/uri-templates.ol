...
<body>
    <h1 class="service-name">UriTemplates</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#UriTemplatesIface'>UriTemplatesIface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='UriTemplatesIface' class='resource-label-interface resource-label'>intf</th>
                <th id='UriTemplatesIface' colspan='3' class='content-td'>UriTemplatesIface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>expand</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#ExpandRequest'>ExpandRequest</a>
                ...
                <td class='content-td'>
                    ...
                    <button
                        onclick='openDetails("expand")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_expand' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_expand' style='display:none'>
                <td></td>
            ...
            <tr>
                ...
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#UriMatchRequest'>UriMatchRequest</a>

                    
                    <span class='message-type'>Response:</span>
                    <a href='#MatchResponse'>MatchResponse</a>
                </td>
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='ExpandRequest' colspan='2' class='content-td'>ExpandRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;ExpandRequest<b>:</b>&nbsp;
...
undefined
    ...
    <tr><td></td><td class='content-td'>&#125;
        ...
        <table class='type-definition'>
            <tr>
                <th class='resource-label-type resource-label'>type</th>
                <th id='MatchResponse' colspan='2' class='content-td'>MatchResponse</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;MatchResponse<b>:</b>&nbsp;
...
<b>bool
        ...
        <table class='type-definition'>
            <tr>
                <th class='resource-label-type resource-label'>type</th>
                <th id='UriMatchRequest' colspan='2' class='content-td'>UriMatchRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;UriMatchRequest<b>:</b>&nbsp;
...
<b>string
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;uri
[1,1]
:&nbsp;
