...
<body>
    <h1 class="service-name">Mustache</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#MustacheInterface'>MustacheInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='MustacheInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='MustacheInterface' colspan='3' class='content-td'>MustacheInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>render</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#RenderRequest'>RenderRequest</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'> Renders a mustache template</span>
                    <button
                        onclick='openDetails("render")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_render' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_render' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'> Renders a mustache template</td>
            <tr>
            <tr>
                <td><br></td>
            </tr>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='RenderRequest' colspan='2' class='content-td'>RenderRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;RenderRequest<b>:</b>&nbsp;
                    
    
    <b>void
</b>
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;template
[1,1]
:&nbsp;
...
undefined
    ...
    </td><td class='documentation'>&lt; The mustache template</td></tr>

        <tr><td></td><td class='content-td'>&nbsp;&nbsp;dir
[0,1]
:&nbsp;
...
<b>string
    ...
    </td><td class='documentation'>&lt; The data for the template</td></tr>

        <tr><td></td><td class='content-td'>&nbsp;&nbsp;recursionLimit
[0,1]
:&nbsp;
...
<b>int
    ...
    </td><td class='documentation'>&lt; The directory in which to look for other templates (for partials)</td></tr>

        <tr><td></td><td class='content-td'>&nbsp;&nbsp;partialsRecursionLimit
[0,1]
:&nbsp;
...
<b>int
    ...
    </td><td class='documentation'>&lt; Maximum limit for recursive calls in partials. Default is 100</td></tr>
...
<b>int
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;partials
[0,1]
:&nbsp;
...
<b>string
    ...
    </td><td class='documentation'>&lt; List of other templates to be used</td></tr>
...
<b>int
    ...
    </td><td class='documentation'>&lt; Maximum limit for recursive calls in partials</td></tr>
