...
<body>
    <h1 class="service-name">Bluetooth</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#BluetoothInterface'>BluetoothInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='BluetoothInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='BluetoothInterface' colspan='3' class='content-td'>BluetoothInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>inquire</span></td>
                <td class='content-td'>
                    ...
                    <a href='#BluetoothInquiryResponse'>BluetoothInquiryResponse</a>
                </td>
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("inquire")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_inquire' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_inquire' style='display:none'>
                <td></td>
            ...
            <tr>
                ...
                <td class='content-td operation-name'><span>setDiscoverable</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#int'>int</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'><br>	  Sets the current Bluetooth device as discoverable or not discoverable<br>	  @request: 0 if the device has to be set not discoverable, 1 if the device has to be set discoverable.<br>	 </span>
                    <button
                        onclick='openDetails("setDiscoverable")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_setDiscoverable' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_setDiscoverable' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'><br>	  Sets the current Bluetooth device as discoverable or not discoverable<br>	  @request: 0 if the device has to be set not discoverable, 1 if the device has to be set discoverable.<br>	 </td>
            <tr>
            <tr>
                <td><br></td>
            </tr>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='BluetoothInquiryResponse' colspan='2' class='content-td'>BluetoothInquiryResponse</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;BluetoothInquiryResponse<b>:</b>&nbsp;
...
<b>string
    ...
    <tr><td></td><td class='content-td'>&nbsp;&nbsp;&#125;
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;device
[0,1]
:&nbsp;
...
<b>void
    ...
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;&nbsp;&nbsp;address
[1,1]
:&nbsp;
