...
<body>
    <h1 class="service-name">HTMLUtils</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#HTMLUtilsInterface'>HTMLUtilsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='HTMLUtilsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='HTMLUtilsInterface' colspan='3' class='content-td'>HTMLUtilsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>escapeHTML</span></td>
                <td class='content-td'>
                ...
                <td class='content-td'>
                    ...
                    <button
                        onclick='openDetails("escapeHTML")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_escapeHTML' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_escapeHTML' style='display:none'>
                <td></td>
            ...
            <tr>
                ...
                <td class='content-td operation-name'><span>unescapeHTML</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#string'>string</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("unescapeHTML")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_unescapeHTML' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_unescapeHTML' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'></td>
            <tr>
            <tr>
