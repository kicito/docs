...
<body>
    <h1 class="service-name">IniUtils</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#IniUtilsInterface'>IniUtilsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='IniUtilsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='IniUtilsInterface' colspan='3' class='content-td'>IniUtilsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>parseIniFile</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#parseIniFileRequest'>parseIniFileRequest</a>

                    
                    <span class='message-type'>Response:</span>
                    <a href='#IniData'>IniData</a>
                </td>
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("parseIniFile")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_parseIniFile' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_parseIniFile' style='display:none'>
                <td></td>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='IniData' colspan='2' class='content-td'>IniData</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;IniData<b>:</b>&nbsp;
...
<b>void
        ...
        <table class='type-definition'>
            <tr>
                <th class='resource-label-type resource-label'>type</th>
                <th id='parseIniFileRequest' colspan='2' class='content-td'>parseIniFileRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;parseIniFileRequest<b>:</b>&nbsp;
