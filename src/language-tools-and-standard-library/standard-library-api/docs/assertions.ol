...
<body>
    <h1 class="service-name">Assertions</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#AssertionsInterface'>AssertionsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='AssertionsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='AssertionsInterface' colspan='3' class='content-td'>AssertionsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td'>
                    ...
                    <a href='#AssertionRequest'>AssertionRequest</a>
            ...
            <tr id='faults_equals' style='display:none'>
                ...
                <td class='content-td'><span class='message-type'>Faults:</span>
                    <br><span class='fault-name'>AssertionError</span>
(
                    string
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='AssertionRequest' colspan='2' class='content-td'>AssertionRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;AssertionRequest<b>:</b>&nbsp;
...
<b>void
    ...
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;actual
[1,1]
:&nbsp;
...
undefined
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;expected
[1,1]
:&nbsp;
