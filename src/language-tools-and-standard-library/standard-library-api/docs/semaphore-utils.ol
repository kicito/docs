...
<body>
    <h1 class="service-name">SemaphoreUtils</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#SemaphoreUtilsInterface'>SemaphoreUtilsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='SemaphoreUtilsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='SemaphoreUtilsInterface' colspan='3' class='content-td'>SemaphoreUtilsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>acquire</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#SemaphoreRequest'>SemaphoreRequest</a>
            ...
            <tr id='doc_acquire' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'><br>	  Acquires permits from a semaphore.<br>	  If there exists no semaphore with the given ".name", "acquire" creates a <br>	  new semaphore with 0 permits with that name.<br>	  The operation returns a response when a new permit is released (see operation "release").<br>	  The default behaviour when value ".permits" is absent is to acquire one permit.<br>	 </td>
            <tr>
            <tr>
                <td><br></td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>release</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#SemaphoreRequest'>SemaphoreRequest</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'><br>	 Releases permits to a semaphore.<br>	 If there exists no semaphore with the given ".name", "release" creates a<br>	 new semaphore with that name and as many permits as indicated in ".permits".<br>	 The default behaviour when value ".permits" is absent is to release one permit.<br>	</span>
                    <button
                        onclick='openDetails("release")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_release' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_release' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'><br>	 Releases permits to a semaphore.<br>	 If there exists no semaphore with the given ".name", "release" creates a<br>	 new semaphore with that name and as many permits as indicated in ".permits".<br>	 The default behaviour when value ".permits" is absent is to release one permit.<br>	</td>
            <tr>
            <tr>
                <td><br></td>
            </tr>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='SemaphoreRequest' colspan='2' class='content-td'>SemaphoreRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;SemaphoreRequest<b>:</b>&nbsp;
...
<b>void
    ...
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;permits
[0,1]
:&nbsp;
...
<b>int
    ...
    </td><td class='documentation'> the optional number of permits to release/acquire</td></tr>
