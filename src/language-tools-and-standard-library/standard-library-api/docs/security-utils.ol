...
<body>
    <h1 class="service-name">SecurityUtils</h1>
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#SecurityUtilsInterface'>SecurityUtilsInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='SecurityUtilsInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='SecurityUtilsInterface' colspan='3' class='content-td'>SecurityUtilsInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>createSecureToken</span></td>
                <td class='content-td'>
                ...
                <td class='content-td'>
                    ...
                    <button
                        onclick='openDetails("createSecureToken")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_createSecureToken' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_createSecureToken' style='display:none'>
                <td></td>
            ...
            <tr>
                ...
                <td class='content-td operation-name'><span>secureRandom</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#SecureRandomRequest'>SecureRandomRequest</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("secureRandom")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_secureRandom' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_secureRandom' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'></td>
            <tr>
            <tr>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='SecureRandomRequest' colspan='2' class='content-td'>SecureRandomRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;SecureRandomRequest<b>:</b>&nbsp;
