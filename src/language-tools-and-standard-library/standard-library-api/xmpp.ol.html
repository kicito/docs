...
<body>
    ...
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#XMPPInterface'>XMPPInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='XMPPInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='XMPPInterface' colspan='3' class='content-td'>XMPPInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td'>
                    ...
                    <a href='#ConnectionRequest'>ConnectionRequest</a>
            ...
            <tr id='faults_connect' style='display:none'>
                ...
                <td class='content-td'><span class='message-type'>Faults:</span>
                    <br><span class='fault-name'>XMPPException</span>
(
            ...
            <tr>
                ...
                <td class='content-td operation-name'><span>sendMessage</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#SendMessageRequest'>SendMessageRequest</a>
                ...
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("sendMessage")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_sendMessage' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
...
(
            ...
            <tr id='doc_sendMessage' style='display:none'>
                <td></td>
                <td colspan='3' class='documentation'></td>
            <tr>
            <tr>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='ConnectionRequest' colspan='2' class='content-td'>ConnectionRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;ConnectionRequest<b>:</b>&nbsp;
...
<b>int
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;resource
[0,1]
:&nbsp;
...
<b>string
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;serviceName
[1,1]
:&nbsp;
...
<b>string
    ...
    <tr><td></td><td class='content-td'>&#125;
        ...
        <table class='type-definition'>
            <tr>
                <th class='resource-label-type resource-label'>type</th>
                <th id='SendMessageRequest' colspan='2' class='content-td'>SendMessageRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;SendMessageRequest<b>:</b>&nbsp;
