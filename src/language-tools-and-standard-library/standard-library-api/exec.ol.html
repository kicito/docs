...
<body>
    ...
    <table class='port-definition'>
        ...
        <tr>
            ...
            <td class='content-td'>
                <a href='#ExecInterface'>ExecInterface<a>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <hr>
        <table class='interface-definition'>
            <tr>
                <th id='ExecInterface' class='resource-label-interface resource-label'>intf</th>
                <th id='ExecInterface' colspan='3' class='content-td'>ExecInterface</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class='content-td operation-name'><span>exec</span></td>
                <td class='content-td'>
                    <span class='message-type'>Request:</span>
                    <a href='#CommandExecutionRequest'>CommandExecutionRequest</a>

                    
                    <span class='message-type'>Response:</span>
                    <a href='#CommandExecutionResult'>CommandExecutionResult</a>
                </td>
                <td class='content-td'>
                    <span class='documentation documentation-inline-block'></span>
                    <button
                        onclick='openDetails("exec")' class='operation-button'>Details</button>
                </td>
            </tr>
            <tr id='faults_exec' style='display:none'>
                <td>
                </td>
                <td></td>
                <td></td>
            ...
            <tr id='doc_exec' style='display:none'>
                <td></td>
        ...
        <table class='type-definition'>
            <tr>
                ...
                <th id='CommandExecutionRequest' colspan='2' class='content-td'>CommandExecutionRequest</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;CommandExecutionRequest<b>:</b>&nbsp;
...
<b>string
    ...
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;args
[0,1]
:&nbsp;
...
<b>string
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;workingDirectory
[0,1]
:&nbsp;
...
<b>string
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;stdOutConsoleEnable
[0,1]
:&nbsp;
...
<b>bool
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;waitFor
[0,1]
:&nbsp;
...
<b>int
    ...
    <tr><td></td><td class='content-td'>&#125;
        ...
        <table class='type-definition'>
            <tr>
                <th class='resource-label-type resource-label'>type</th>
                <th id='CommandExecutionResult' colspan='2' class='content-td'>CommandExecutionResult</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td class='content-td'><b>type</b>&nbsp;CommandExecutionResult<b>:</b>&nbsp;
...
<b>any
    ...
    &#123; </td><td class='documentation'></td></tr>
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;exitCode
[0,1]
:&nbsp;
...
<b>int
        ...
        <tr><td></td><td class='content-td'>&nbsp;&nbsp;stderr
[0,1]
:&nbsp;
